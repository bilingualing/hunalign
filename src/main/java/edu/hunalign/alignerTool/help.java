...
public class help {
    ...
    public static String helpString = "Usage (either):"+
    "alignerTool [ common_arguments ] [ -hand=hand_align_file ] dictionary_file source_text target_text"+//n
    "or:"+//n
    "alignerTool [ common_arguments ] -batch dictionary_file batch_file"+ //n
    "where"+//\n\
